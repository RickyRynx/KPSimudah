            ...
            <div class="col-xl-8 col-lg-7 mx-auto">
                <div class="card shadow mb-2">
                    ...
                    <div class="card-header py-3">
                        <h1>Register Akun Admin Keuangan</h1>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('addAdminKeuangan.store') }}" method="POST">
                            @csrf
                            <div class="card-body" style="display: flex; flex-direction: column;">
                                ...
                                <a href="{{ route('addAdminKeuangan.index') }}" class="btn btn-auto btn-primary shadow-sm">
