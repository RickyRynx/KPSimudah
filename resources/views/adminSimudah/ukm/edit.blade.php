            ...
            <form action="{{ route('ukm.update', $ukm->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="pembina_id" name="pembina_id">
                        ...
                        @foreach($users as $user)
                            <option value="{{ $user->id }}" {{ $ukm->pembina_id == $user->id ? 'selected' : '' }}>{{ $user->name }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="pelatih_id" name="pelatih_id">
                        ...
                        @foreach($users as $user)
                            <option value="{{ $user->id }}" {{ $ukm->pelatih_id == $user->id ? 'selected' : '' }}>{{ $user->name }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="ketuaMahasiswa_id" name="ketuaMahasiswa_id">
                        ...
                        @foreach($users as $user)
                            <option value="{{ $user->id }}" {{ $ukm->ketuaMahasiswa_id == $user->id ? 'selected' : '' }}>{{ $user->name }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="status_user" name="status_user">
                        ...
                        <option value="Tidak Aktif" {{ $ukm->status_user == 'Tidak Aktif' ? 'selected' : '' }}>Tidak Aktif</option>
                    </select>
                </div>
