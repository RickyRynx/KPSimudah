...
<head>
    ...
    <title>SIMUDAH - Absensi Mahasiswa</title>
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <a class="sidebar-brand d-flex align-items-center justify-content-center"
                    href="/dashboardBidangKemahasiswaan">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="/dashboardBidangKemahasiswaan">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="/laporanMahasiswaBidangKemahasiswaan">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                    ...
                                    <a class="dropdown-item"
                                        href="{{ route('profileBidangKemahasiswaan.edit', Auth::user()->id) }}">
