...
<head>
    ...
    <title>SIMUDAH - Pengumuman</title>
    ...
    <header id="header" class="header">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <!-- Sidebar - Brand -->
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/dashboardPelatih">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="/dashboardPelatih">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                    ...
                                    <a class="dropdown-item"
                                        href="{{ route('profilePelatih.edit', Auth::user()->id) }}">
