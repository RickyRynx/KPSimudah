        ...
        <div class="card shadow m-4">
            <div class="card-header py-3">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-0">
                    <a href="{{ route('jadwal.create') }}" class="btn btn-auto  btn-primary shadow-sm">
                ...
                <div class="table-responsive mt-3">
                    <table class="table table-bordered" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                <th scope="col">No</th>
                                <th scope="col" class="table-border">Tanggal Kegiatan</th>
                                <th scope="col" class="table-border">Agenda Kegiatan</th>
                                <th scope="col" class="table-border">Lokasi Kegiatan</th>
                                <th scope="col" class="table-border">Penanggung Jawab</th>
                                <th scope="col" class="table-border">Pelatih</th>
