...
<div class="container">
    ...
    <form action="{{ route('inventaris.update', $inventaris->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="jumlah_rusak" name="jumlah_rusak" value="{{ $inventaris->jumlah_rusak }}" required>
        </div>

        <div class="mb-3">
            <label for="jumlah_bagus" class="form-label">Jumlah Bagus</label>
            <input type="number" class="form-control" id="jumlah_bagus" name="jumlah_bagus" value="{{ $inventaris->jumlah_bagus }}" required>
        </div>
