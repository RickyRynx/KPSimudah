        ...
        <div class="card shadow m-4">
            <div class="card-header py-3">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-0">
                    <a href="/absensiPelatih/addAbsensiPelatih" class="btn btn-auto  btn-primary shadow-sm">
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" style="border: 1px solid; padding: 8px; text-align: left;">Tanggal/Waktu
                                </th>
                                <th scope="col" style="border: 1px solid; padding: 8px; text-align: left;">Jumlah Hadir
                                </th>
                                <th scope="col" style="border: 1px solid; padding: 8px; text-align: left;">Jumlah Izin
                                </th>
                                <th scope="col" style="border: 1px solid; padding: 8px; text-align: left;">Jumlah Alfa
                                </th>
                                <th scope="col" style="border: 1px solid; padding: 8px; text-align: left;">Keterangan
                                </th>
                                <th scope="col" style="border: 1px solid; padding: 8px; text-align: left;">Foto</th>
                                <th scope="col" style="border: 1px solid; padding: 8px; text-align: left;">Jam Mulai</th>
                                <th scope="col" style="border: 1px solid; padding: 8px; text-align: left;">Jam Berakhir
                                </th>
                                <th scope="col" style="border: 1px solid; padding: 8px; text-align: left;">Durasi</th>
