@extends('layout.masterPengumumanPelatih')
@section('content')
    <div class="container">
        ...
        <div class="card shadow m-4">
            <div class="card-header py-3">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-0">
                    <a href="/pengumumanPelatih/addPengumumanPelatih" class="btn btn-auto  btn-primary shadow-sm">
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" style="border: 1px solid; padding: 8px; text-align: left;">Judul</th>
                                <th scope="col" style="border: 1px solid; padding: 8px; text-align: left;">Isi Pengumuman
                                </th>
                                <th scope="col" style="border: 1px solid; padding: 8px; text-align: left;">Upload By</th>
                                <th scope="col" style="border: 1px solid; padding: 8px; text-align: left;">Waktu Upload
                                </th>
