@extends('layout.masterJadwalPelatih')
@section('content')
    <div class="container">
        ...
        <div class="card shadow m-4">
            <div class="card-header py-3">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-0">
                    <a href="/jadwalPelatih/addJadwalPelatih" class="btn btn-auto  btn-primary shadow-sm">
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" style="border: 1px solid; padding: 8px; text-align: left;">Tanggal
                                    Kegiatan</th>
                                <th scope="col" style="border: 1px solid; padding: 8px; text-align: left;">Agenda
                                    Kegiatan</th>
                                <th scope="col" style="border: 1px solid; padding: 8px; text-align: left;">Lokasi
                                    Kegiatan</th>
                                <th scope="col" style="border: 1px solid; padding: 8px; text-align: left;">Penanggung
                                    Jawab</th>
                                <th scope="col" style="border: 1px solid; padding: 8px; text-align: left;">Pelatih</th>
