        ...
        <div class="card shadow m-4">
            <div class="card-header py-3">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-0">
                    <a href="/kegiatanPelatih/addKegiatanPelatih" class="btn btn-auto  btn-primary shadow-sm">
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" style="border: 1px solid; padding: 8px; text-align: left;">No Usulan</th>
                                <th scope="col" style="border: 1px solid; padding: 8px; text-align: left;">Nama
                                    Kegiatan/Lomba</th>
                                <th scope="col" style="border: 1px solid; padding: 8px; text-align: left;">Afiliasi Lomba
                                </th>
                                <th scope="col" style="border: 1px solid; padding: 8px; text-align: left;">File Usulan
                                    Lomba</th>
                                <th scope="col" style="border: 1px solid; padding: 8px; text-align: left;">Skala Lomba
                                </th>
                                <th scope="col" style="border: 1px solid; padding: 8px; text-align: left;">Laporan</th>
